export interface DesignGen { title: string; description?: string; image: Buffer; }
export interface DesignDel { id: string; }
export interface DesignUpd { id: string; title: string; description?: string; buffer?: Buffer; key: string; }
export interface DesignRecord { id: string; key: string; title: string; description: string | null; provider: "UPLOADTHINGS" | "CFR2" | "AWSS3"; createdAt: Date; updatedAt: Date; }
